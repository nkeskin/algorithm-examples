...
public class SearchOnSortedTest {
  ...
  @Test
  void case1() {
    Assertions.assertEquals(0, searchOnSorted.search(new int[]{4, 5, 6, 7, 0, 1, 2}, 1));
  }
  ...
  @Test
  void case3() {
    Assertions.assertEquals(0, searchOnSorted.search(new int[]{5, 1, 3}, 1));
  }
